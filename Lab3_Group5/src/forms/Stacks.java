...
public class Stacks extends javax.swing.JFrame {
    ...
    private stackOperation stack;
    
    public Stacks() {
        initComponents();
        stack = new stackOperation(5);
        updateDisplay();
    }

    private void updateDisplay(){
        display.setText(stack.getStack());
    }
    ...
    private void popActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popActionPerformed
       ...
       if (remove == null) {
           ...
           JOptionPane.showMessageDialog(this, "Removed: " + remove);
       }
       updateDisplay();
    ...
    private void pushActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pushActionPerformed
        ...
        boolean pushed = stack.push(input);
        if (!pushed){
